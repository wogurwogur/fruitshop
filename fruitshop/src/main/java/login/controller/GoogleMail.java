...
public class GoogleMail {
	...
	public void send_certification_code(String recipient, String certification_code) throws Exception { 
    	...
    	prop.put("mail.smtp.user", "mailserver2123@gmail.com"); 
    ...
    */ 
    	...
    	// 제목 설정
    	String subject = "localhost:9090/fruitshop/index.ddg 회원님의 비밀번호를 찾기위한 인증코드 발송";
    	msg.setSubject(subject);
    	        
    	// 보내는 사람의 메일주소
    	String sender = "mailserver2123@gmail.com";
