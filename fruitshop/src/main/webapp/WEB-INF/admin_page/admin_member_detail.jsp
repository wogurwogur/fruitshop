	...
	<table class="table" style="text-align:center;">
		<tbody>
			<tr>
				...
				<c:if test="${empty requestScope.currentShowPageNo}"><td><button type="button" class="btn btn-outline-secondary" onclick="javascript:location.href='<%=ctxPath%>/admin/adminManagement.ddg?searchType=${requestScope.searchType}&sizePerPage=10&searchWord=${requestScope.searchWord}&currentShowPageNo=1'">돌아가기</button></td></c:if>
				<c:if test="${not empty requestScope.currentShowPageNo}"><td><button type="button" class="btn btn-outline-secondary" onclick="javascript:location.href='<%=ctxPath%>/admin/adminManagement.ddg?searchType=${requestScope.searchType}&sizePerPage=10&searchWord=${requestScope.searchWord}&currentShowPageNo=${requestScope.currentShowPageNo}'">돌아가기</button></td></c:if>
			</tr>
		</tbody>
	</table>
