		...
		<div style="width:450px; margin : 10px auto;">
			...
			<div style="margin : 0 auto;">
	        	...
	        	<span class="btn float-right"  style="height:50px; line-height:40px;">
	            	<a href="<%=request.getContextPath()%>/login/idFind.ddg" id="idFind" style="color:black;">아이디찾기</a> / 
	            	<a href="<%=request.getContextPath()%>/login/passwdFind.ddg" id="passwdFind" style="color:black;">비밀번호찾기</a>
	            </span>
	        </div>
