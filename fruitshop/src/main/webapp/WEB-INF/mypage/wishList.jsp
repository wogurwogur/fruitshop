...
<div class="container" style="margin-top: 2%;">
	...
	<%-- 
	<form method="post" action="<%= request.getContextPath() %>/mypage/wishList.ddg" onsubmit= "return confirm('정말로 관심상품을 모두 비우시겠습니까?'); ">
	<input type="hidden" name="wish_no" value="${item.fk_user_no}">
	</form>
    --%>
