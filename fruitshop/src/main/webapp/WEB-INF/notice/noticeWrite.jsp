...
<form name="noticeWriteFrm">
	<div id="title">	
		<div class="d-flex mt-5">
			...
			<textarea name="notice_title" cols="130" rows="1" style="resize:none;"></textarea>
		</div>	
	</div>
...
<%-- 내용 --%>
	...
	<div id="buttons">
		<div class="d-flex" style="margin-left:25%;">
			<button type="button" class="btn btn-outline-dark mt-3" style="width:120px;" onclick="location.href='<%=ctxPath%>/notice/noticeList.ddg?searchType=${requestScope.searchType}&sizePerPage=10&searchWord=${requestScope.searchWord}&currentShowPageNo=${requestScope.currentShowPageNo}'">목록</button>	
				
			<div class="ml-auto d-flex align-items-center" style="margin-right:21%; width:30%;" >
				<button type="submit" class="btn btn-outline-dark mt-3" style="width:120px;" onclick="noticeRegister()">등록</button>
