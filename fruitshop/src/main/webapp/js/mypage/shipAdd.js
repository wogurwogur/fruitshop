...
$(()=>{
    ...
    // 연락처2 (국번)
    $("input#ship_receivertel2").bind('keyup', e => { 

        const ship_receivertel2_length = $("input#ship_receivertel2").val().length;

        if(ship_receivertel2_length == 4) {

            $("input#ship_receivertel3").focus();
    ...
    // 연락처3 
    $("input#ship_receivertel3").bind('blur', e => { 

        const ship_receivertel2 = $("input#ship_receivertel2").val(); 

        const regExp_ship_receivertel2 = new RegExp(/^[1-9][0-9]{3}$/); 

        const bool2 = regExp_ship_receivertel2.test(ship_receivertel2);

        const ship_receivertel3 = $("input#ship_receivertel3").val(); 
    ...
    $("input:text[name='ship_extraAddress']").attr("readonly", true);
